...
function App() {
  ...
  return (
    <div className="App">
      <div className="bot-army-section">
        <h2>Your Bot Army</h2>
        <YourBotArmy botArmy={botArmy} onRemoveBot={handleRemoveEnlisted} />
      </div>
      <div className="main-section">
        <h1>Welcome to Bot Army Recruitment</h1>
        <SortBar onSort={handleSort} activeSort={sortBy} />
        <BotCollection
          onRetireBot={handleRetire}
          bots={botsDisplay}
          onDisplayBotInfo={handleDisplayBotInfo}
        />
      </div>
      {selectedBot && (
        <div className="bot-specs-section">
          <BotSpecs
